...
import Audio from './images/red.mp3';

function Chat() {
    return (
        <div className=" bg-blue-400 w-full h-full top-16 relative flex flex-col justify-center">
        ...
        <div className="flex justify-center">
         <div className="bg-gray-300 relative w-2/3 h-full mt-20 rounded-lg hover:bg-gray-50 transition duration-700 ease-in-out">
          <h1 className="font-serif font-bold flex justify-center mt-6 text-3xl text-gray-500 hover:text-red-600 transition duration-700 ease-in-out">Rot·käppchen</h1>
          <div>
             <audio className="left-3 -top-10 relative" controls>
                 <source src={Audio} />
             </audio>
         </div>
          <p className="flex justify-center font-bold mt-7 ml-2 text-gray-600 hover:text-gray-700">Es war einmal: So fangen Märchen an.
             ...
             Und Kuchen.
             Dann sagt die Mutter zu Rot∙käppchen:<br/>
             ...
             Deshalb hat Rot∙käppchen auch keine Angst vor dem Wolf.<br/>
             Der Wolf sieht Rot·käppchen.
             Und sagt:<br/>
             Hallo Rot∙käppchen.
             Rot∙käppchen antwortet:
             Hallo Wolf.
             Der Wolf fragt Rot∙käppchen:<br/>
             Wohin gehst du?
             Rot∙käppchen antwortet:<br/>
             ...
             Und schwach.
             Meine Groß∙mutter soll wieder gesund werden.<br/>
             ...
             Das Haus steht unter den 3 Eichen.<br/>
             ...
             Und der Wolf will die Groß∙mutter fressen.<br/>
             ...
             Die Groß·mutter fragt:<br/>
             Wer ist da?

             Der Wolf antwortet mit hoher Stimme:<br/>
             Rot∙käppchen.
             Ich bringe dir einen Korb von der Mutter.
                Die Groß∙mutter sagt:<br/>
                Komm nur herein.
                Ich kann nicht aufstehen.
                Der Wolf geht zum Bett von der Groß∙mutter.
                Und der Wolf frisst die Groß∙mutter ganz schnell.
                Dann zieht der Wolf die Kleider von der Groß∙mutter an.<br/>
                ...
                Deshalb fragt Rot∙käppchen:<br/>
                        Liebe Groß·mutter.
                        Warum hast du so große Ohren?
                Und der Wolf antwortet mit hoher Stimme:<br/>
                        So kann ich dich besser hören.
                Und Rot∙käppchen fragt:<br/>
                        Liebe Groß·mutter.
                ...
                Der Wolf antwortet:<br/>
                        So kann ich dich besser packen.
                        Liebe Groß·mutter.
                        Warum hast du so einen großen Mund?
                Und der Wolf antwortet mit tiefer Stimme::<br/>
         ...
         <div className="bg-gray-300 relative w-2/3 h-full mt-20 rounded-lg hover:bg-gray-50 transition duration-700 ease-in-out">
          ...
          <p className="flex justify-center mt-7 ml-2 text-gray-600 hover:text-black">Es war einmal: So fangen Märchen an.
             Ein Märchen ist eine sehr alte Geschichte.
             Dieses Märchen heißt: Rot∙käppchen.
             Das Märchen geht so

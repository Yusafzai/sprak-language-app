...
function Video() {
    return (
        <div className=" bg-purple-400 w-full h-full top-16 relative flex justify-center">
             
          <div className="bg-gray-100 w-96 h-20 top-20 relative -ml-56 rounded-md hover:bg-pink-300 transition duration-700 ease-in-out">
              <p className="text-6xl text-gray-600 ml-28 mt-2">Video</p>
              </div>
